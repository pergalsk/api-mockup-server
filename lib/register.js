...
function getRouter(serverOptions) {
  ...
  let routesList = getActiveRoutes(routes);
  ...
  // TODO: exact count of active registered routes - don't count not accepted routes
  // log.serverMsg(_t('ACTIVE_REGISTERED_ROUTES', { number: routesList.length }));
