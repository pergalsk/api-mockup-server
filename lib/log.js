 ...
 * and prefix charactes length.
 * @param {number} [separatorLength] Number of charactes to output
 */
...
/**
 * Logs decorated message with information about port which application is tisten on.
 * @param {Object} serverOptions Simple mock server options
 * @param {Array} [routesList] Unused
 */
 ...
 * @param {string} target Proxy server addres
 */
 ...
 * which indicates conditionaly mocked routes.
