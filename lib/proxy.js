...
/**
 * Generates `onProxyMethod` needed for intercept proxy responses.
 * @param {string} encoding Proxy response buffer encodding (e.g. 'UTF8')
 ...
 * @param {Array<Object>} routes Routes deined in Simple mock server options
 ...
 * @async
 * @param {string|Array<string>} proxy Simple Mock Server proxy options
